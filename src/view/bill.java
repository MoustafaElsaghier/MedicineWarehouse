...
public class bill extends javax.swing.JPanel {
    ...
    public bill() throws SQLException {
        initComponents();
         ...
         bill_attribute bill = new bill_attribute();
        bill_control c = new bill_control();
        Object data[][] = c.getalldatabill(bill);
        String headTable[] = {"name", "date", "type", "total"};
    ...
    private void initComponents() {
        ...
        tname.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
        ...
        ttotal.setFont(new java.awt.Font("SansSerif", 1, 24)); // NOI18N
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addComponent(ttotal, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(17, 17, 17)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tname, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ttotal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
 ...
 Object data[][] = null;
        ...
        if (ttotal.getText().equals("")) {
            ...
            ttotal.setBackground(Color.red);
        }
...
//        
        if (Flag == 1) {
            return;
             ...
             bill.setName(tname.getText());
            bill.setDate(tdate.getText());
             bill.setTotal(Integer.parseInt(ttotal.getText()));

            bill.setType(ttype.getText());
    ...
    private void tsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tsearchKeyReleased
         ...
         bill_attribute  bill = new  bill_attribute();
         bill_control c = new  bill_control();
         bill.setSearch(tsearch.getText());
        try {
            Object data[][] = c.searchbill( bill);
            String headTable[] = {"name", "date", "type", "total"};
            DefaultTableModel modle = new DefaultTableModel(data, headTable);
            table.setModel(modle);
        } catch (SQLException ex) {
